...
class Messagescreen extends StatefulWidget {
  ...
  const Messagescreen({super.key, required this.peerId, required this.peerName, required this.peerPhotoUrl});
...
class _MessagescreenState extends State<Messagescreen> {
  ...
  void initState() {
    ...
    chatroomId = context.read<ChatRepository>().getChatroomId(currentUserId, widget.peerId);
  }
          ...
          children: [
            ...
            Expanded(
              child: StreamBuilder<QuerySnapshot>(
                stream: context.read<ChatRepository>().getMessages(chatroomId),
